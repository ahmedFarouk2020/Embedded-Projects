...
static u8 data3[32]= {62,9,9,9,62,0,63,8,8,56,0,62,4,60,4,60,0,62,42,42,46,0,56,40,40,63,0,0,0,0,0,0};
//static u8 dataArrID;
...
void HLEDMRX_voidEnableHamada(void)
{
	staticImage = 0 ;
	HLEDMRX_u8EnableShift = 0;
	hamada = 1;
